...
BASE_SCHEMA = vol.Schema(
    {
        ...
        vol.Optional(CONF_USERNAME, default=""): str,   # optional auth
        vol.Optional(CONF_PASSWORD, default=""): str,   # optional auth
    }
)
        ...
        schema = vol.Schema(
            {
                ...
                vol.Optional(
                    CONF_BASE_PATH, default=(d.get(CONF_BASE_PATH) or "")
                ): str,
                vol.Optional(
                    CONF_USERNAME, default=(d.get(CONF_USERNAME) or "")
                ): str,
                vol.Optional(
                    CONF_PASSWORD, default=(d.get(CONF_PASSWORD) or "")
                ): str,
            }
        )
